  ...
  return (
    <li className="rounded-lg border px-3 py-2">
      <div className="flex flex-wrap items-center gap-1.5">
        ...
        {!draft.isAiGenerated && <Badge variant="outline">Edited by you</Badge>}
        {draft.limitedContext && (
          <Badge variant="outline" className="border-amber-300 bg-amber-50 text-amber-800" title="Little stored context exists for this person — review carefully instead of trusting personalization.">
            Light on context
          </Badge>
        )}
      </div>
...
export function OutreachDetail() {
  ...
  return (
    <div className="max-w-3xl">
      ...
      <h1 className="text-2xl font-semibold tracking-tight">{batch.intent}</h1>
